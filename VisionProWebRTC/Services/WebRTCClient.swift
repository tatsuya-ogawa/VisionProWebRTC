...
//    private var videoCapturer: RTCVideoCapturer?
    private var visionProVideoCapturer: VisionProRTCVideoCapturer?
    ...
    required init(iceServers: [RTCIceServer], isAudioOn: Bool,isMicrophoneOn: Bool) {
    ...
    func configureAudioSession() {
        ...
        audioSession.isAudioEnabled = true
            do {
                ...
                try
                audioSession.setCategory(AVAudioSession.Category.playAndRecord, with:.defaultToSpeaker)
...
//
    ...
    func startCapture()async{
        guard let capturer = self.visionProVideoCapturer else {
            return
        }
...
//        videoCapturer = RTCCameraVideoCapturer(delegate: videoSource)
        visionProVideoCapturer = .init(delegate: videoSource)
